...
Bug fixes:
- Fixed Wayland JVM crash that affected users with nVidia graphics drivers ([52a12e9](https://github.com/seraxis/lr2oraja-endlessdream/commit/52a12e9b64852015ad8877be84d70829672325e0))
